      ...
      <div class="col-lg-12">
        ...
        <div class="card">
          <div class="card-body">
            ...
            <form method="POST" action="../inc/carga.php">
              <div style="width:20%; margin-left: 76px;">
                <label for="inputDate" class="col-sm-6 col-form-label" style="margin-left: 0px;">Dia / Mês</label>
                <input type="date" class="form-control col-sm-3" name="dataPesquisa"><br> <button class="btn btn-primary" type="submit">CAR</button>
              </div>
            </form>
          <?php echo $las; ?>
            <hr style="opacity: 0;">
            ...
            <form>
              <div class="container col-lg-6" style="margin-left: 0px;">
                ...
                <div class="row" style="margin-left:43px;">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control" value=""style="padding: 0rem 0rem;">
                  </div>
                </div>
                <div class="row" style="margin-left:43px;">
                  <div class="col-sm-2">
