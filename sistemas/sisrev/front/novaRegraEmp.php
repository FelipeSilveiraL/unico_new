        ...
        <div class="card">
          <div class="card-body">
            <form class="row g-3" action="" method="post" enctype="multipart/form-data">
              ...
              <input onkeypress="onlynumber()"  class="form-control"  name="numero_caixa" maxlength="2" required>
              <label for="numero_caixa">NUMERO CAIXA:<span style="color: red;">*</span></label>
              </div>
              
              <div class="form-floating mt-4 col-md-6">
              <select  class="form-select" id="liberarApro" name="liberarApro" required>
              <?php 
                require_once('../inc/apiRecebeSelbetti.php');
                echo $aprovador;
              ?>
              </select>
              <label for="liberarApro">APROVADOR CAIXA:<span style="color: red;">*</span></label>
              </div>
